...
namespace NekoSpace.API.Migrations
{
    ...
    [Migration("20221115055148_changeCharacterModels")]
    partial class changeCharacterModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5b05d670-2b90-4a02-85b9-8a42c79f1cda",
                            ConcurrencyStamp = "1",
                            Name = "Administrator",
                        ...
                        new
                        {
                            Id = "773af2ba-52b3-43ba-8e1d-e68fcb3a02fb",
                            ConcurrencyStamp = "1",
                            Name = "Moderator",
                        ...
                        new
                        {
                            Id = "8ff2cd53-6a82-4ae6-a2d9-d130198fbc60",
                            ConcurrencyStamp = "1",
                            Name = "Creator",
                        ...
                        new
                        {
                            Id = "12104f70-d5d3-4016-aa2f-ae6a502b930d",
                            ConcurrencyStamp = "1",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "4e02ba13-3435-4873-8211-86e830efda4b",
                            ConcurrencyStamp = "1",
                            Name = "Guest",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "1a6cf93f-8e73-446f-9341-e9252a2b301e",
                            RoleId = "5b05d670-2b90-4a02-85b9-8a42c79f1cda"
                        });
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Models.User.NekoUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1a6cf93f-8e73-446f-9341-e9252a2b301e",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eccab1ac-ca21-4ba0-9851-a7058c6756b6",
                            ...
                            SecurityStamp = "ecb6e41e-d92d-44d0-bb58-c61ead11077f",
            ...
            modelBuilder.Entity("NekoSpaceList.Models.CharacterModels.AnotherCharacterService", b =>
                {
                    ...
                    b.ToTable("AnotherCharacterService");
                });
            ...
            modelBuilder.Entity("NekoSpaceList.Models.CharacterModels.Character", b =>
                {
                    ...
                    b.Property<Guid>("AnotherServiceId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NekoSpaceList.Models.CharacterModels.Character", b =>
                {
                    b.HasOne("NekoSpaceList.Models.CharacterModels.AnotherCharacterService", "AnotherService")
                        .WithMany()
                        .HasForeignKey("AnotherServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
