...
namespace NekoSpace.Data.Migrations
{
    ...
    [Migration("20230702111021_ChangeMediaStructureTest3")]
    partial class ChangeMediaStructureTest3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c8450a09-371f-48aa-8e84-2a6f7f7ee181",
                            ConcurrencyStamp = "1",
                            Name = "Administrator",
                        ...
                        new
                        {
                            Id = "e6c4d01f-09a1-4c0b-8205-7c42ad257125",
                            ConcurrencyStamp = "1",
                            Name = "Moderator",
                        ...
                        new
                        {
                            Id = "945c71fa-0c2e-4a36-833c-bd45f70300cb",
                            ConcurrencyStamp = "1",
                            Name = "Creator",
                        ...
                        new
                        {
                            Id = "59084f9e-a517-40b7-80f4-8463a5f8d16f",
                            ConcurrencyStamp = "1",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "b4d9a12b-eeaa-4a17-a79f-06627255065d",
                            ConcurrencyStamp = "1",
                            Name = "Guest",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "ce2d0255-95b8-4f0d-ac76-23f8951f452a",
                            RoleId = "c8450a09-371f-48aa-8e84-2a6f7f7ee181"
                        });
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Models.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ce2d0255-95b8-4f0d-ac76-23f8951f452a",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7f59025a-cf84-475d-916f-7a239a6ffd45",
                            ...
                            SecurityStamp = "ad40f48c-3713-4056-b318-cf75785a259c",
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.AssociatedServiceEntity", b =>
                {
                    b.HasOne("NekoSpaceList.Models.Anime.AnimeEntity", "AnimeEntity")
                        .WithMany("AssociatedService")
                        .HasForeignKey("AnimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NekoSpaceList.Models.CharacterModels.CharacterEntity", "CharacterEntity")
                        .WithMany("AssociatedService")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NekoSpaceList.Models.Manga.MangaEntity", "MangaEntity")
                        .WithMany("AssociatedService")
                        .HasForeignKey("MangaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AnimeEntity");

                    b.Navigation("CharacterEntity");
