...
namespace NekoSpace.Data.Migrations
{
    ...
    [Migration("20230721232648_UpdateImageRelationForTest3")]
    partial class UpdateImageRelationForTest3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9f0e1653-86eb-42b2-9e4b-dbf3139c18f4",
                            ConcurrencyStamp = "1",
                            Name = "Administrator",
                        ...
                        new
                        {
                            Id = "d31b1093-a22d-44b1-9708-f930b2b964c6",
                            ConcurrencyStamp = "1",
                            Name = "Moderator",
                        ...
                        new
                        {
                            Id = "424dee6a-9fb5-45a7-b3ad-9d2e7e584693",
                            ConcurrencyStamp = "1",
                            Name = "Creator",
                        ...
                        new
                        {
                            Id = "b2a1b5c4-7839-451a-bc83-15dd17df3ac3",
                            ConcurrencyStamp = "1",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "da72fe2c-f51d-4f42-81a3-5bf63dc6d9a7",
                            ConcurrencyStamp = "1",
                            Name = "Guest",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "fb0b32b8-35a7-4366-8a68-7752fa8aac5a",
                            RoleId = "9f0e1653-86eb-42b2-9e4b-dbf3139c18f4"
                        });
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Models.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fb0b32b8-35a7-4366-8a68-7752fa8aac5a",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "459757d6-b560-4130-9368-932103340e10",
                            ...
                            SecurityStamp = "565a7a36-64ad-4ea5-ac5c-8bb306f0c449",
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.CoverEntity", b =>
                {
                    ...
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.ImageEntity", null)
                        .WithOne()
                        .HasForeignKey("NekoSpace.Data.Contracts.Entities.General.CoverEntity", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.PosterEntity", b =>
                {
                    ...
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.ImageEntity", null)
                        .WithOne()
                        .HasForeignKey("NekoSpace.Data.Contracts.Entities.General.PosterEntity", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
