...
namespace NekoSpace.Data.Migrations
{
    ...
    [Migration("20230724104818_UpdateImageRelationForTest13")]
    partial class UpdateImageRelationForTest13
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0a2d7862-edf8-4026-bc0f-6eff1c756c33",
                            ConcurrencyStamp = "1",
                            Name = "Administrator",
                        ...
                        new
                        {
                            Id = "d54241d9-3330-438a-9d9e-06a74e87cc01",
                            ConcurrencyStamp = "1",
                            Name = "Moderator",
                        ...
                        new
                        {
                            Id = "b9d3aeea-ab1d-4dd1-a4ca-65971f793352",
                            ConcurrencyStamp = "1",
                            Name = "Creator",
                        ...
                        new
                        {
                            Id = "a49fa0f6-7b16-48ee-8ee8-1b48b4a82ba2",
                            ConcurrencyStamp = "1",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "3ff43889-ef56-4e11-ab68-5320a769022c",
                            ConcurrencyStamp = "1",
                            Name = "Guest",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "2a9ec42f-23be-4bbd-b7e2-b47e7c25c950",
                            RoleId = "0a2d7862-edf8-4026-bc0f-6eff1c756c33"
                        });
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Models.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2a9ec42f-23be-4bbd-b7e2-b47e7c25c950",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4c61b3a5-bd02-4486-bc36-de7128b9cf69",
                            ...
                            SecurityStamp = "59e47f2f-fbd5-42e1-bfdf-df8a34283dcd",
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.Anime.AnimeCoverEntity", b =>
                {
                    b.HasBaseType("NekoSpace.Data.Contracts.Entities.General.CoverEntity");
                    ...
                    b.ToTable("Cover_Media");
                });

            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.Anime.AnimePosterEntity", b =>
                {
                    b.HasBaseType("NekoSpace.Data.Contracts.Entities.General.PosterEntity");
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.CoverEntity", b =>
                {
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.ImageEntity", null)
                        .WithOne()
                        .HasForeignKey("NekoSpace.Data.Contracts.Entities.General.CoverEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.PosterEntity", b =>
                {
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.ImageEntity", null)
                        .WithOne()
                        .HasForeignKey("NekoSpace.Data.Contracts.Entities.General.PosterEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.Anime.AnimeCoverEntity", b =>
                {
                    ...
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.CoverEntity", null)
                        .WithOne()
                        .HasForeignKey("NekoSpace.Data.Contracts.Entities.Anime.AnimeCoverEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.Anime.AnimePosterEntity", b =>
                {
                    ...
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.PosterEntity", null)
                        .WithOne()
                        .HasForeignKey("NekoSpace.Data.Contracts.Entities.Anime.AnimePosterEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
