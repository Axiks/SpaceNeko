...
namespace NekoSpace.Data.Migrations
{
    ...
    [Migration("20230724130147_UpdateImageRelationForTest18")]
    partial class UpdateImageRelationForTest18
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1dc636a3-1ed6-4555-8fba-79e7d23793f0",
                            ConcurrencyStamp = "1",
                            Name = "Administrator",
                        ...
                        new
                        {
                            Id = "d2f945a9-71c1-4ce3-b2fc-6a296a10de61",
                            ConcurrencyStamp = "1",
                            Name = "Moderator",
                        ...
                        new
                        {
                            Id = "c1d0f310-2806-43f7-9324-8f53f3692483",
                            ConcurrencyStamp = "1",
                            Name = "Creator",
                        ...
                        new
                        {
                            Id = "d2826481-3999-409c-a09b-c8b72c4923bf",
                            ConcurrencyStamp = "1",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "ad8c8a0f-4905-42ac-95a0-9e486a6a9545",
                            ConcurrencyStamp = "1",
                            Name = "Guest",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "25bbc59b-bd52-413e-bd61-233b83e2c7be",
                            RoleId = "1dc636a3-1ed6-4555-8fba-79e7d23793f0"
                        });
                });
            ...
            modelBuilder.Entity("NekoSpace.Data.Models.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "25bbc59b-bd52-413e-bd61-233b83e2c7be",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "83cac04f-676e-4209-833b-2b8d7486ba34",
                            ...
                            SecurityStamp = "8895dbe9-534b-4421-a90a-6a48850493d5",
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.MediaCoverEntity", b =>
                {
                    b.HasBaseType("NekoSpace.Data.Contracts.Entities.General.ImageEntity");
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.MediaPosterEntity", b =>
                {
                    b.HasBaseType("NekoSpace.Data.Contracts.Entities.General.ImageEntity");
            ...
            modelBuilder.Entity("NekoSpace.Data.Contracts.Entities.General.MediaCoverEntity", b =>
                {
                    b.HasOne("NekoSpace.Data.Contracts.Entities.General.ImageEntity", "Image")
                        .WithMany()
