...
{
    public class MediaRepository : AbstractMediaRepository<MediaEntity, ElasticSearchMediaBasicModel>
    {
        private IMapper _mapper;
        private Language _primaryLang;
        private Language _secondaryLang;
        public MediaRepository(ApplicationDbContext dbcontext, IElasticSearchRepository<ElasticSearchMediaBasicModel> esrepository, IMapper mapper) : base(dbcontext, esrepository, mapper)
        {
        }
        ...
        public ResponseMedia Find(GetMediaQueryParameters parameters)
        {
            ...
            var esObj = FindInElasticSearch(elasticSearchQueryParameters);
